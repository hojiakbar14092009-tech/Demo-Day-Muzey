            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
                ...
                <nav className="flex items-center gap-1 rounded-full border border-frame bg-slate/60 p-1">
                    <button
                        ...
                        className={`flex items-center gap-2 rounded-full px-3 py-2 font-sans text-xs uppercase tracking-widest transition-all sm:px-5 ${view === 'user'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 rounded-full px-3 py-2 font-sans text-xs uppercase tracking-widest transition-all sm:px-5 ${view === 'admin'
                                ? 'bg-gold text-obsidian shadow-gilded'
                                : 'text-alabaster/70 hover:text-gold-light'
                            }`}
                    >
